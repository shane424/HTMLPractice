...
<p>If you&#39;re looking to display multiple pages of data without the need to click &#39;Next&#39; or manually select a page, use Griddle&#39;s infinite scrolling feature! One will need to set the &#39;infiniteScroll&#39; property to true in Griddle, as well as include the maximum height of the scrollable area (in pixels).</p>
<dl>
...
<pre><code><span class="tag">&lt;<span class="title">Griddle</span> <span class="attribute">results</span>=<span class="value">{fakeData}</span> <span class="attribute">columnMetadata</span>=<span class="value">{columnMeta}</span> <span class="attribute">resultsPerPage</span>=<span class="value">{5}</span> <span class="attribute">infiniteScroll</span>=<span class="value">{true}</span> <span class="attribute">bodyHeight</span>=<span class="value">{400}</span>/&gt;</span></code></pre>
<div id="griddle-infinite-scroll"></div>

<script type="text/jsx">
  React.render(<Griddle results={fakeData} columnMetadata={columnMeta} resultsPerPage={5} infiniteScroll={true} bodyHeight={400}/>, document.getElementById('griddle-infinite-scroll'));
</script>
...
<h5 id="example-">Example:</h5>
<pre><code><span class="tag">&lt;<span class="title">Griddle</span> <span class="attribute">results</span>=<span class="value">{fakeData}</span> <span class="attribute">columnMetadata</span>=<span class="value">{columnMeta}</span> <span class="attribute">resultsPerPage</span>=<span class="value">{5}</span> <span class="attribute">infiniteScroll</span>=<span class="value">{true}</span> <span class="attribute">useFixedHeader</span>=<span class="value">{true}</span> <span class="attribute">bodyHeight</span>=<span class="value">{400}</span>/&gt;</span></code></pre>
<div id="griddle-infinite-fixed-header"></div>

<script type="text/jsx">
    React.render(<Griddle results={fakeData} columnMetadata={columnMeta} resultsPerPage={5} infiniteScroll={true} useFixedHeader={true} bodyHeight={400}/>, document.getElementById('griddle-infinite-fixed-header'));
</script>
...
<pre><code><span class="tag">&lt;<span class="title">GriddleWithCallback</span> <span class="attribute">showFilter</span>=<span class="value">{true}</span> <span class="attribute">getExternalResults</span>=<span class="value">{fakeDataMethod}</span>
 <span class="attribute">loadingComponent</span>=<span class="value">{Loading}</span> <span class="attribute">infiniteScroll</span>=<span class="value">{true}</span> <span class="attribute">useFixedHeader</span>=<span class="value">{true}</span> <span class="attribute">bodyHeight</span>=<span class="value">{400}</span>/&gt;</span></code></pre>
...
<script type="text/jsx">
    ...
    React.render(<GriddleWithCallback getExternalResults={fakeDataMethod} loadingComponent={Loading} infiniteScroll={true} useFixedHeader={true} bodyHeight={400}/>, document.getElementById("griddle-external"));
</script>
