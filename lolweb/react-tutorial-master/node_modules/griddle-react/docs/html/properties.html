...
var propertiesItem = [
  ...
  },
  {
    ...
    "description": "The height of a fake row to give the table body additional height if there are more rows that can be loaded when infinite scrolling is enabled.",
    "type": "int",
    "default": "50"
  },
  {
...
React.render(<Griddle results={propertiesItem} useCustomRowFormat={true} customRowFormat={DefinitionItem} useGriddleStyles={false} showFilter={true} tableClassName="table" resultsPerPage={100} columnMetadata={propertyGridMeta} showPager={false} />, document.getElementById('griddle-properties'));
</script>
