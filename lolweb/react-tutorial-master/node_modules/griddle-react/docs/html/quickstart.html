...
<span class="comment">npm</span> <span class="comment">install</span> <span class="comment">griddle</span>-<span class="comment">react</span> <span class="literal">-</span><span class="literal">-</span><span class="comment">save</code></pre>
...
React.render(<Griddle results={fakeData} />, document.getElementById("griddle-basic"));
</script>
...
<pre><code><span class="tag">&lt;<span class="title">Griddle</span> <span class="attribute">results</span>=<span class="value">{fakeData}</span> <span class="attribute">tableClassName</span>=<span class="value">"table"</span> <span class="attribute">showFilter</span>=<span class="value">{true}</span> <span class="attribute">showSettings</span>=<span class="value">{true}</span> <span class="attribute">columns</span>=<span class="value">{["name",</span> "<span class="attribute">city</span>", "<span class="attribute">state</span>", "<span class="attribute">country</span>"]}/&gt;</span></code></pre>
<div id="griddle-advanced"></div>

<script type="text/jsx">
React.render(<Griddle results={fakeData} tableClassName="table" showFilter={true} showSettings={true} columns={["name", "city", "state", "country"]}/>, document.getElementById("griddle-advanced"));
</script>
