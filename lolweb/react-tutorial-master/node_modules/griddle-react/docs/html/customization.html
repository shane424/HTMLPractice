	...
	<header class="background-primary-dark border-bottom border-secondary">
		<div class="container">
			<div class="twelve columns right">
				<iframe src="http://ghbtns.com/github-btn.html?user=DynamicTyped&repo=Griddle&type=watch&count=true"
				allowtransparency="true" frameborder="0" scrolling="0" width="90" height="20"></iframe>
				<iframe src="http://ghbtns.com/github-btn.html?user=DynamicTyped&repo=Griddle&type=fork&count=true"
				allowtransparency="true" frameborder="0" scrolling="0" width="90" height="20"></iframe>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="four columns">
					<a href="/"><img src="images/griddle.png" alt="Griddle"/></a>
				</div>
			</div>
		</div>
	</header>
...
<p>Custom column components are defined in the <a href="#">Column Metadata object</a>. The components are passed <strong>data</strong> and <strong>rowData</strong> properties.</p>
<dl>
  <dt>data</dt>
...
<p>From there, we will set the customComponent value in the <strong>name</strong> columnMetadata object to this LinkComponent.</p>
...
<pre><code>React.render(<span class="xml"><span class="tag">&lt;<span class="title">Griddle</span> <span class="attribute">data</span>=<span class="value">{someData}</span> <span class="attribute">columnMetdata</span>=<span class="value">{columnMeta}</span> /&gt;</span>,
...
<p>From there, Griddle can be rendered with the useCustomRowFormat and customRowFormat properties:</p>
...
React.render(
  <Griddle results={fakeData} useCustomRowFormat={true} customRowFormat={OtherComponent} customRowFormatClassName={"custom-row"} allowToggleCustom={true} showSettings={true} showFilter={true}/>,
...
<p>In some cases, it may be ideal to use Griddle but display a global format other than a grid or series of rows. Assume we have an object containing temperature data for years and we want to display this data with a trend line chart. This is possible with a custom grid format component. To use custom grid formatting the <strong>useCustomGridFormat</strong> and <strong>customGridFormat</strong> properties need to be set.</p>
<dl>
...
React.render(<Griddle allowToggleCustom={true} showSettings={true} results={data} useCustomGridFormat={true} customGridFormat={TestLineChart} tableClassName="table"/>, document.getElementById('grid-chart'));
</script>
...
<p>If you want to customize the paging component, just set the property &#39;useCustomPager&#39; to true and pass in another component as property named &#39;customPager&#39;. The example component below shows 11 buttons (5 previous, current, 5 next):</p>
<dl>
...
<pre><code><span class="tag">&lt;<span class="title">Griddle</span> <span class="attribute">results</span>=<span class="value">{fakeData}</span> <span class="attribute">tableClassName</span>=<span class="value">"table"</span> <span class="attribute">useCustomFormat</span>=<span class="value">"true"</span> 
  <span class="attribute">customFormat</span>=<span class="value">{OtherComponent}</span> <span class="attribute">useCustomPager</span>=<span class="value">"true"</span> <span class="attribute">customPager</span>=<span class="value">{OtherPager}</span> /&gt;</span></code></pre>
...
React.render(<Griddle results={fakeData} tableClassName="table" useCustomFormat="true" 
  customFormat={OtherComponent} useCustomPager="true" customPager={OtherPager} />, document.getElementById("custom-paging"));
</script>
...
<script type="text/jsx">
    React.render(<Griddle noDataMessage={"No data could be found."} />, document.getElementById("griddle-nodata-basic"));
</script>
...
<script type="text/jsx">
  ...
  React.render(<Griddle customNoDataComponent={NoDataComponent} />, document.getElementById("griddle-nodata-component"));
</script>
