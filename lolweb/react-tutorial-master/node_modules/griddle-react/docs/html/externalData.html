...
<pre><code><span class="keyword">var</span> ExternalComponent = React.createClass({
    ...
    changeSortDirection: <span class="keyword">function</span>(sort, sortAscending){
    },
...
<pre><code class="lang-javascript"><span class="keyword">var</span> ExternalSwapiComponent = React.createClass({
    ...
    render: <span class="keyword">function</span>(){
      ...
      <span class="keyword">return</span> <span class="xml"><span class="tag">&lt;<span class="title">Griddle</span> <span class="attribute">useExternal</span>=<span class="value">{true}</span> <span class="attribute">externalSetPage</span>=<span class="value">{this.setPage}</span> <span class="attribute">enableSort</span>=<span class="value">{false}</span> <span class="attribute">columns</span>=<span class="value">{["name",</span> "<span class="attribute">model</span>", "<span class="attribute">manufacturer</span>", "<span class="attribute">passengers</span>"]}
        <span class="attribute">externalSetPageSize</span>=<span class="value">{this.setPageSize}</span> <span class="attribute">externalMaxPage</span>=<span class="value">{this.state.maxPages}</span>
...
React.render(<GriddleWithCallback getExternalResults={loadData} loadingComponent={Loading} enableSort={false} columns={["name", "model", "manufacturer", "passengers"]} resultsPerPage={10} showFilter={false} showSettings={false} />, document.getElementById('griddle-callback')); 
</script>
			</div>
		</div>
	</div>
